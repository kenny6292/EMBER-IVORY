...
export default function AdminLogin(){
  ...
  return <main className="flex min-h-screen items-center justify-center bg-[#171513] px-5 text-[#f5f0e6]">
    <div className="w-full max-w-md">
      ...
      <form onSubmit={submit} className="mt-10 grid gap-5">
        ...
        <button disabled={loading} className="bg-[#b9572b] px-5 py-4 text-xs uppercase tracking-[.18em] disabled:opacity-50">{loading?"Signing in…":"Continue"}</button>
      </form>
    </div>
  </main>
}